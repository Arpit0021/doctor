...
# Enhanced segmentation overlay with XAI explanations
def advanced_visualize(image_array):
    try:
        ...
        ax2.imshow(overlay)
        ax2.set_title("AI Segmentation Overlay")
        ax2.axis('off')
        ...
        xai_explanation = f"""
        **Explainable AI (XAI) Segmentation Analysis:**
        ...
        **Clinical Interpretation:**
        The segmentation highlights regions of potential clinical interest by grouping pixels with similar characteristics.
        Boundaries between segments may indicate transitions between different tissue types or pathological changes.
        """
